...
// Source: gocircum/mobile/bridge (interfaces: StatusUpdater)
//
// Generated by this command:
//
//	mockgen -package=mocks -destination=../../mocks/mock_status_updater.go gocircum/mobile/bridge StatusUpdater
//
