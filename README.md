...
[![golangci-lint](https://img.shields.io/github/actions/workflow/status/SourceShift/gocircum/lint.yml?branch=main&label=lint)](https://github.com/SourceShift/gocircum/actions/workflows/lint.yml)
